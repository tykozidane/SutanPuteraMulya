...
<head>
  ...
  <title>PT Sutan Putera Mulya</title>
  <script type="text/javascript" src="js/main.js"></script>
  <!-- Favicons -->
  <link href="img/logodoang.png" rel="icon">
  <link href="img/logodoang.png" rel="apple-touch-icon">
...
<body>  
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <!--<h1><a href="/">Mamba</a></h1>
        ...
        <a href="/"><img src="img/logofix.png" alt="PT Sultan Putera Mulya" class="img-fluid-logo"></a>
      </div>
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope-fill"></i><a href="mailto:tyokdazi2015@gmail.com">sutanputeramulya@gmail.com</a>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Industries</a></li>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
            ...
            <div class="section-title">
              <h2>About Us</h2>
              <p>Kami adalah perusahaan yang bergerak dalam bidang .... yang menyediakan berbagai kebutuhan dan pelayanan yang anda butuhkan</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bx bx-fingerprint"></i></div>
              <h4 class="title"><a href="#industries">Lorem Ipsum</a></h4>
              <p class="description">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bx bx-gift"></i></div>
              <h4 class="title"><a href="#product">Nemo Enim</a></h4>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="info-box">
            <i class="bx fa-envelope-open-text"></i>
              <h3>Email Us</h3>
